...
gB_ChrChr_misolessthan62 = gB_ChrChr_miso(angle(gB_ChrChr_miso) < 62*degree);
%Only consider the gB_ChrChr_miso with angle between 58 and 62
gB_ChrChr_miso58_62 = gB_ChrChr_misolessthan62(angle(gB_ChrChr_misolessthan62) > 58*degree);
gB_ChrChr_miso58_62Axes =  axis(gB_ChrChr_miso58_62)
...
% plotAxisDistribution(gB_ChrChr_miso58_62,'contourf',mtexFig.gca)
 plot(gB_ChrChr_miso58_62Axes,'antipodal','contourf')
